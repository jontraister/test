...
<div id="wraper">
  ...
  <div class="cb"></div>
  <div id="Content">
    <?php $qry = Run("SELECT * FROM ".PRE."benners WHERE id='10'");
		  $picrow=GetRow($qry);
	?>
    <div class="banner"> <img src="pics/banner/<?php echo $picrow['image'];?>" alt="Banner" width="959" height="425" /> </div> 
    <!--banner-->
    <div id="bodycontent">
    
      <!--<div class="OptionCover">
        <div class="aboutCover">
          <div class="aboutpic"><a href="aboutus.php"><img src="images/04.jpg" alt="About" /></a></div>
        </div>
        <div class="ServicesCover">
          <div class="Servicespic"><a href="services.php"><img src="images/02.jpg" alt="Sevices" /></a></div>
        </div>
        <div class="Projects">
          <div class="Servicespic"><a href="photos.php"><img src="images/03.jpg" alt="Recent Projects" /></a></div>
        </div>
      </div>-->
      
      <div class="welcomeCover">
        <div class="welcomeh1"><?=$Heading;?></div>
        <div class="welcometxt"><?=$Contents;?></div>
      </div>
      <!--welcomeCover-->
       <div class="cb"></div>
    </div>
