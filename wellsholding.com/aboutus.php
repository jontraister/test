...
<div id="wraper">
  ...
  <div class="cb"></div>
  <div id="Content">
	<?php $qry = Run("SELECT * FROM ".PRE."benners WHERE id='3'");
		  $picrow=GetRow($qry);
	?>
    <div class="banner1" style="background-image:url(pics/banner/<?php echo $picrow['image'];?>); width:960px; height:300px;"><div style="color: #FFFFFF;font-size: 22px;font-weight: bold;padding-left: 20px;padding-top: 250px;">About us</div></div>    <!--banner-->
    <div id="rightcolo">
      ...
      <!--aboutCover-->
      <div class="aboutsubCover">
        <div class="aboutpic"><a href="sustainability.php"><img src="images/05.jpg" alt="Recent Projects" /></a></div>
      </div>
      <!--aboutCover-->
    </div>
