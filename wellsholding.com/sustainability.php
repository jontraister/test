...
<div id="wraper">
  ...
  <div id="Content">
	<?php $qry = Run("SELECT * FROM ".PRE."benners WHERE id='4'");
		  $picrow=GetRow($qry);
	?>
    <div class="banner1" style="background-image:url(pics/banner/<?php echo $picrow['image'];?>); width:960px; height:300px;"><div style="color: #FFFFFF;font-size: 22px;font-weight: bold;padding-left: 20px;padding-top: 250px;">Sustainability</div></div>   <!--banner-->
    <div id="rightcolo">
