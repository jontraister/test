...
class vImage{
	...
	var $numCirculos = 2; #Numeros de circulos randomicos
	...
	function showCodBox($mode=0,$extra=''){
		$str = "<input type=\"text\" size='22' name=\"vImageCodP\" ".$extra." > ";
	...
	function showCodBox1($mode=0,$extra=''){
	...
	function gerImage(){
		...
		for ($i=1;$i<=$this->numCirculos;$i++) {
			...
			imageellipse($this->im,rand(0,$this->w-10),rand(0,$this->h-2), rand(220,160),rand(120,250),$randomcolor);
		}
		#escrever texto
		$ident = 20;
